...
db_username = os.environ.get("CLOUD_SQL_USERNAME")
db_password = os.environ.get("CLOUD_SQL_PASSWORD")
db_name = os.environ.get("CLOUD_SQL_DATABASE_NAME")
db_connection_name = os.environ.get("CLOUD_SQL_CONNECTION_NAME")
db_hostname = "172.28.48.3"

app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://' + db_username +  ':' + db_password + '@' + db_hostname + ':5432/' + db_name
